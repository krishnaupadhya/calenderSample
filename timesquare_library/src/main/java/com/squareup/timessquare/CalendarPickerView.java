...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    final int bg = a.getColor(R.styleable.CalendarPickerView_android_background,
        res.getColor(R.color.creamy_white));
    ...
    dayBackgroundResId = a.getResourceId(R.styleable.CalendarPickerView_tsquare_dayBackground,
        R.drawable.calender_cell_background);
    ...
    locale = /*Locale.getDefault()*/new Locale(getDefaultLanguage());
  ...
  private static String getDefaultLanguage() {
    ...
    if (language.equalsIgnoreCase("en") || language.equalsIgnoreCase("hi")|| language.equalsIgnoreCase("ta") ||
            language.equalsIgnoreCase("te")||language.equalsIgnoreCase("kn")||language.equalsIgnoreCase("pa")||
            language.equalsIgnoreCase("mr")||language.equalsIgnoreCase("gu")||language.equalsIgnoreCase("bn")||
            language.equalsIgnoreCase("or")||language.equalsIgnoreCase("ml")) {
      return language;
    } else {
      return "en";
    }
  ...
  public FluentInitializer init(Date minDate, Date maxDate) {
    return init(minDate, maxDate, new Locale(getDefaultLanguage()));
  }
...
//    });
  ...
  public void setTitleTypeface(Typeface titleTypeface) {
    this.titleTypeface = Typeface.create("sans-serif-medium", Typeface.NORMAL);
    validateAndUpdate();
  }
  ...
  public void setDateTypeface(Typeface dateTypeface) {
    this.dateTypeface = Typeface.create("sans-serif", Typeface.NORMAL);
    validateAndUpdate();
  }
  ...
  private class MonthAdapter extends BaseAdapter {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
      ...
      monthView.init(months.get(position), cells.get(position), displayOnly, Typeface.create("sans-serif-medium", Typeface.NORMAL),
              dateTypeface);
      return monthView;
    }
  }
