...
public class CalendarPriceModel implements BaseDataModel {
    ...
    private ArrayList<DatePriceInfo> mDatePriceInfoOnward;
    private ArrayList<DatePriceInfo> mDatePriceInfoReturn;
    ...
    private void fillTheArray(JSONObject jsonObj, Iterator<String> keys, boolean isRoundTrip) {
        while (keys.hasNext()) {
            ...
            DatePriceInfo priceInfo = new DatePriceInfo();
...
//                Collections.sort(mDatePriceInfoOnward, new CJRFlightDatePriceInfoCompartor());
    ...
    public ArrayList<DatePriceInfo> getOnwardDatePriceInfo() {
        return mDatePriceInfoOnward;
    }

    public ArrayList<DatePriceInfo> getReturnDatePriceInfo() {
    ...
    private class CJRFlightDatePriceInfoCompartor implements java.util.Comparator<DatePriceInfo> {

        @Override
        public int compare(DatePriceInfo lhs, DatePriceInfo rhs) {
            try {
